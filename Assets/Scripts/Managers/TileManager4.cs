...
public class TileManager4 : MonoBehaviour {
	...
	public class Tile4
	{
		...
		public Tile4 left,right,up,down;
		
		public Tile4(int x_in, int y_in)
		{
			x = x_in; y = y_in;
			occupied = false;
	...
	public List<Tile4> tiles = new List<Tile4>();
...
0001001001001001001001001000
0001001001001001001001001000
0001001111111111111111001000
0001001111000000001111001000
0001001111000000001111001000
0001111111000000001111111000
...
0000000000000000000000000000";
	...
	public int Index(Tile4 tile)
	{
		return (31-tile.y)*28 + tile.x-1;
	}

    // distancia entre dois quadrados
	public float distance(Tile4 tile1, Tile4 tile2)
	{
