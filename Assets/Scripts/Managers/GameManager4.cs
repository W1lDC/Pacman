...
public class GameManager4 : MonoBehaviour
{
    ...
    private GameGUINavigation4 gui;
    ...
    void Start()
    {
        gui = GameObject.Find("UI Manager").GetComponent<GameGUINavigation4>();
        gui.startGame();
    ...
    public void ResetVarScene()
    {
        ...
        pacman.GetComponent<PlayerController4>().ResetDestination();
        blinky.GetComponent<GhostMove4>().InitGhosts();
        pinky.GetComponent<GhostMove4>().InitGhosts();
        inky.GetComponent<GhostMove4>().InitGhosts();
        clyde.GetComponent<GhostMove4>().InitGhosts();
    ...
    {
        scared = true;
        blinky.GetComponent<GhostMove4>().Scare();
        pinky.GetComponent<GhostMove4>().Scare();
        inky.GetComponent<GhostMove4>().Scare();
        clyde.GetComponent<GhostMove4>().Scare();
    ...
    {
        scared = false;
        blinky.GetComponent<GhostMove4>().Calm();
        pinky.GetComponent<GhostMove4>().Calm();
        inky.GetComponent<GhostMove4>().Calm();
        clyde.GetComponent<GhostMove4>().Calm();
    ...
    void DesignateGhosts()
    {
        ...
        gui = GameObject.FindObjectOfType<GameGUINavigation4>();
    ...
    {
        pacman.GetComponent<PlayerController4>().lives--;
        currentLives = pacman.GetComponent<PlayerController4>().lives;
