...
public class TileManager3 : MonoBehaviour {
	...
	public class Tile3
	{
		...
		public Tile3 left,right,up,down;
		
		public Tile3(int x_in, int y_in)
		{
			x = x_in; y = y_in;
			occupied = false;
	...
	public List<Tile3> tiles = new List<Tile3>();
...
0001001001000000001001001000
0001111001000000001001111000
0001001001000000001001001000
0001001001000000001001001000
0001001001111111111001001000
0001001001000000001001001000
0001001001000000001001001000
0111111111111111111111111110
0100001001000000001001000010
...
0000000000000000000000000000";
	...
	public int Index(Tile3 tile)
	{
		return (31-tile.y)*28 + tile.x-1;
	}

    // distancia entre dois quadrados
	public float distance(Tile3 tile1, Tile3 tile2)
	{
