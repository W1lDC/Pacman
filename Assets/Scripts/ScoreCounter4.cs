...
public class ScoreCounter4 : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        HigherScore = PlayerPrefs.GetInt("Higher4");
        score = 0;
    ...
    void Update()
    {
        ...
        GameObject.Find("Score4").GetComponent<Text>().text = string.Format("{0:00000}", score);
        GameObject.Find("Higher4").GetComponent<Text>().text = string.Format("{0:00000}", PlayerPrefs.GetInt("Higher4"));

        //no gameover screen apresenta os valores 
        GameObject.Find("YourScoreOver").GetComponent<Text>().text = string.Format("{0:00000}", score);
        GameObject.Find("YourBestScoreOver").GetComponent<Text>().text = string.Format("{0:00000}", PlayerPrefs.GetInt("Higher4"));

        //no gamewin screen apresenta os valores
        GameObject.Find("YourScoreWin").GetComponent<Text>().text = string.Format("{0:00000}", score);
        GameObject.Find("YourBestScoreWin").GetComponent<Text>().text = string.Format("{0:00000}", PlayerPrefs.GetInt("Higher4"));
    }

    void OnDestroy()// quando o nivel acaba, o variavel higherscore é guardada
    {
        PlayerPrefs.SetInt("Higher4", HigherScore);
        PlayerPrefs.Save();
    }
