...
public class AI2 : MonoBehaviour {
	...
	private List<TileManager2.Tile2> tiles = new List<TileManager2.Tile2>();
	private TileManager2 manager;
	public GhostMove2 ghost;
	public TileManager2.Tile2 nextTile = null;
	public TileManager2.Tile2 targetTile;
	TileManager2.Tile2 currentTile;

	void Awake()
	{
		manager = GameObject.Find("Game Manager2").GetComponent<TileManager2>();
		tiles = manager.tiles;
	...
	public void AILogic()
	{
		...
		{
			ghost.direction = ghost.direction;	// update do valor setter
		}
	}
	...
	public void RunLogic()
	{
		...
		if(nextTile.occupied || currentTile.isIntersection)
		{
			...
			if(currentTile.isIntersection)
			{
				List<TileManager2.Tile2> availableTiles = new List<TileManager2.Tile2>();
				TileManager2.Tile2 chosenTile;
	...
	TileManager2.Tile2 GetTargetTilePerGhost()
	{
		Vector3 targetPos;
		TileManager2.Tile2 targetTile;
		Vector3 dir;
		...
		case "pinky":	// alvo = pacman + 4* direçao dopacman (4 passos a frente do pacman)
			dir = target.GetComponent<PlayerController2>().getDir();
